var header_TransactionStop = function () {
    var menuName = "TransactionStop_", fd = "TransactionData/" + menuName + "data.php";
    ...
    function exportExcel(btn) {
        ...
        if (dataT1.count() > 0) {
            ...
            worker.addEventListener('message', function (e) {
                saveAs(e.data, 'tspkmr_transaction_billing' + dayjs().format('YYYYMMDDTHHmmss') + ".xlsx");
                btn.enable();
    ...
    return {
        view: "scrollview",
        scroll: "native-y",
        id: "header_TransactionStop",
        body:
        {
            id: "TransactionStop_id",
            type: "space",
            rows:
                [
                    { view: "template", template: "TRNSACTION BILLING", type: "header" },
                    {
                                                ...
                                                vw1("button", 'btnExport', "Export", {
                                                    ...
                                                    on:
                                                    {
                                                        onItemClick: function () {
                                                            ...
                                                            if (dataT1.count() != 0) {
                                                                webix.extend($$("TransactionStop_id"), webix.ProgressBar);
                                                                ele("btnExport").disable();
                                                                $$("TransactionStop_id").showProgress({
                                                                    type: "top",
                                                                    delay: 5000,
                                                                    hide: true
                                                                });
                                                                            ...
                                                                            if (json.ch == 1) {
                                                                                webix.alert({
                                                                                    title: "<b>ข้อความจากระบบ</b>", type: "alert-complete", ok: 'ตกลง', text: 'Export Complete', callback: function () {
                                                                                        ...
                                                                                        $$("TransactionStop_id").hideProgress();
                                ...
                                },
                                {
                                    ...
                                    columns:
                                        [
                                            ...
                                            { id: "qty_actual", header: [{ text: "Actual", css: { "text-align": "center" } }, { text: "Qty", css: { "text-align": "center" } } ], width: 60, css: { "text-align": "center" }, },
                                            { id: "diff_qty", header: [{ text: "Diff", css: { "text-align": "center" } }, { text: "Qty", css: { "text-align": "center" } } ], width: 60, css: { "text-align": "center" }, },
                                            ...
                                            { id: "cbm_actual", header: [{ text: "Actual CBM", css: { "text-align": "center" } }, { text: "CBM", css: { "text-align": "center" } } ], width: 60, css: { "text-align": "center" }, },
                                            { id: "diff_cbm", header: [{ text: "Diff", css: { "text-align": "center" } }, { text: "CBM", css: { "text-align": "center" } } ], width: 60, css: { "text-align": "center" }, },
